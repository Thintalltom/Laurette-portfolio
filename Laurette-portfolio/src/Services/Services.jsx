  ...
  return (
    <div className='mt-[20rem]'>
        ...
        <div className=' mt-[30px] cursor-pointer md:flex-col sm:flex-col xs:flex-col lg:flex-row xxl:flex-row flex justify-center items-center gap-[50px] mt-[20px]'>
            ...
            <p className='text-zinc-300 font-extralight mt-[5px] p-4 text-center'>My Ghostwriting service is arranged to bring your story
            ...
            <p className='p-4 text-zinc-300 font-extralight text-center'>Few readers purchase a book without first redaing a few pages. 
            ...
            <p className='p-4 text-zinc-300 font-extralight text-center'>I pride on birthing awesome books, especially books written by up-and-coming writers of African decent. We believe that everyone has a story to tell and that's why we help writers accomplish their goals
               </p>
            </div>
            <div className='bg-zinc-950 w-[300px] h-[450px]'>
            ...
            <p className='p-4 text-zinc-300 font-extralight text-center '>I give up and coming writers one-on-one guidance for  their work in progress. I value writers at every level 
