    ...
    <div>
      {loading ? (
        ...
        <div className="p-4 mt-4 ">
          <p className="text-center lg:text-2xl sm:text-md font-bold">
            {fiction.name}
          </p>
          ...
          <div className="mt-4 text-sm">
            {fiction.body.split("\n").map((paragraph, index) => (
              <p key={index} className=" text-justify mb-[20px] leading-[30px] px-4 lg:px-20">
                {paragraph}
              </p>
            ))}
          </div>

          <p className="mt-4 text-sm px-4 lg:px-20 ">
